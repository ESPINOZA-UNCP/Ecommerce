                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            <a href="#" class="btn btn-sm btn-info mr-4">{{ __('left btn') }}</a>
                            <a href="#" class="btn btn-sm btn-default float-right">{{ __('right btn') }}</a>
                        </div>
                    </div>
                    <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    <div>
                                        ...
                                        <span class="description">{{ __('ejemplo') }}</span>
                                    </div>
                                    <div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('text, text') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Role') }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('Role') }}
                            </div>
                            <hr class="my-4" />
                            <p>{{ __('paragraph') }}</p>
                            <a href="#">{{ __('paragraph display') }}</a>
                        </div>
                    </div>
                </div>
            </div>
